...
class DocumentProcessor {
    spellCheckRange(document, callback, sline, scharacter, eline, echaracter) {}
    spellCheckAll(document, callback) {
        var startline = 0;
        var endline = Number.MAX_SAFE_INTEGER;

        this.spellCheckRange(document, callback, startline, void 0, endline, void 0);
    }
}
