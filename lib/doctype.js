...
//
// comment_start, comment_end, comment_line
// string_inline, string_multiline, string_quote
// code_start, code_end
...
function fromLanguage(id) {
    switch (id) {
        ...
        case 'pascal':
            return new Standard_1.default({ start: '\\{', end: '\\}', line: '//', string: '["\']', quote: '\\' });
        case 'd':
            return new Standard_1.default({ start: '\\/\\*', end: '\\*\\/', line: '//', string: '["\']', string_multiline: '`', quote: '\\' });
        case 'clojure':
            return null;
        case 'coffeescript':
            return new Standard_1.default({ start: '###\\*?', end: '###', line: '#' });
        ...
        case 'html':
            return new Xml_1.default(true);
        case 'http':
            return new Standard_1.default({ line: '#', string: '"' });
        case 'mustache':
            return new Xml_1.default(true);
        case 'ini':
            return new Standard_1.default({ line: '[#;]' });
