...
cp build/Release/spellchecker.node ../spellchecker-linux-42.4.0-x64.node

npx node-gyp rebuild --target=42.4.0 --arch=ia32 --dist-url=https://electronjs.org/headers
cp build/Release/spellchecker.node ../spellchecker-linux-42.4.0-ia32.node
