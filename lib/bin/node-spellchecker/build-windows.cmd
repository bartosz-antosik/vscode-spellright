...
call npx node-gyp rebuild --target=6.0.9 --arch=ia32 --python=c:\bin\python27\python.exe --dist-url=https://electronjs.org/headers
copy build\Release\spellchecker.node ..\spellchecker-win32-6.0.9-ia32.node

call npx node-gyp rebuild --target=6.0.9 --arch=x64 --python=c:\bin\python27\python.exe --dist-url=https://electronjs.org/headers
