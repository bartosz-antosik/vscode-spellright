...
call node-gyp rebuild --target=2.0.7 --arch=ia32 --dist-url=https://atom.io/download/electron
copy build\Release\spellchecker.node ..\spellchecker-win32-2.0.7-ia32.node

call node-gyp rebuild --target=2.0.7 --arch=x64 --dist-url=https://atom.io/download/electron
copy build\Release\spellchecker.node ..\spellchecker-win32-2.0.7-x64.node
