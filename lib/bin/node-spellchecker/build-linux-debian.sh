...
node-gyp rebuild --target=4.2.5 --arch=ia32 --dist-url=https://atom.io/download/electron
cp build/Release/spellchecker.node ../spellchecker-deb-4.2.5-ia32.node

node-gyp rebuild --target=4.2.5 --arch=x64 --dist-url=https://atom.io/download/electron
cp build/Release/spellchecker.node ../spellchecker-deb-4.2.5-x64.node
