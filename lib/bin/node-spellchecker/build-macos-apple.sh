...
npx node-gyp rebuild --target=22.4.8 --arch=arm64 --dist-url=https://electronjs.org/headers
cp build/Release/spellchecker.node ../spellchecker-macos-22.4.8-arm64.node
