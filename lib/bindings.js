...
const loadBinary = function (baseName) {
  ...
  nodeFiles.forEach((file) => {
    // brute force try to load the node extension across operating systems and versions, use whichever loads at all
    // TO be researched: why not use https://nodejs.org/api/process.html#process_process_platform and why 
    //    are there separate binaries for redhat and debian distros? Does this rely on system libraries not in the LSB?
    try {
      if (binding == null) {
