...
- **New:** SpellRight should now work in remote hosts (e.g. WSL on Windows, Linux via SSH etc.), thanks to [@bwegge](@https://github.com/bwegge) and [@ flindeberg](https://github.com/flindeberg).
