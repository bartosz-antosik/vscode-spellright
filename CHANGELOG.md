...
- **New:** Handling of unknown document types added ([#102](https://github.com/bartosz-antosik/vscode-spellright/issues/#102)) and ([#104](https://github.com/bartosz-antosik/vscode-spellright/issues/#104)) via interface and `spellright.parserByClass` configuration item.
