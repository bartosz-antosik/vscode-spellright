...
## **3.0.86** released on 18th August 2022

- **New:** SpellRight should now work in remote hosts (e.g. WSL on Windows, Linux via SSH, GitHub repositiries etc.), thanks to [@bwegge](@https://github.com/bwegge) and [@ flindeberg](https://github.com/flindeberg).
